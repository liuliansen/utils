...
class IdCardHelper
{
     ...
     * @var array
     */
    protected  static  $idCardPrefix = [
        '362429','110107','140108','130227','411024',
     ...
     * @var array
     */
    static protected $familyName = [
        '刘','李','张','王','赵','钱','孙','黄','金','蒋',
        '魏','卢','鲁','常','颜','闫','后','刑','杜','关',
        '邱','冯','秦','吕','吴','梁','高','习','贺','马',
        '朱','牛','欧阳','黄埔','公孙','苏','苗','程','叶',
        '崔','雷','江','祁','龙','余','高','曹','丁','甘',
        '廖','曾','白','万','卢','毛','姚','罗','巩','聂'
    ];
     ...
     * @var array
     */
    static protected $maleChars = [
        '亮','雨','伟','涛','敏','军','建','翔','森','飞','晋',
     ...
     * @var array
     */
    static protected $femaleChars = [
        '雨','敏','菲','秀','丽','婧','涵','蕊','语','翠','花',
     ...
     * @return mixed
     */
    public static function getFamilyNameWithRandom()
    {
        return static::$familyName[mt_rand(0, count(static::$familyName)-1)];
    }
     ...
     * @return string
     */
    public static function getAppellationWithRand()
    {
        return mt_rand(1,2) % 2 == 0 ? '先生':'女士';
    }
