...
class Log
{
    ...
    public static function init($config = [])
    {
        ...
        if (class_exists($class)) {
            ...
            throw new \Exception('class not exists:' . $class, Errors::SERVER_ERROR);
        }
    }
     ...
     * @return bool
     */
    public static function save($conf = [])
    {
        // 没有需要保存的记录则直接返回
        if (empty(self::$log)) {
            return true;
        ...
        is_null(self::$driver) && self::init($conf);
